...
import { JobCard, Meta } from "../components";
...
const Applicants = () => {
  ...
  return (
    <div className="container mx-auto">
      <Meta
        title="Job Applicants | Worknity"
        description="Browse through applicants for your job listings on Worknity. Review resumes, view profiles, and find the best candidates for your open positions."
        url={`https://worknity.netlify.app/applicants/${id}`}
      />
                ...
                (profile) =>
                  profile?.data && (
                    ...
                    >
                      ...
                      <div>
                        <p className="max-[360px]:hidden bg-[#1d4fd826] text-[#1d4fd8] py-0.5 px-1.5 rounded font-semibold text-sm">
                          {" "}
                          {moment(profile.data.user.createdAt).fromNow()}
                        </p>
                      </div>
                    </div>
                  )
