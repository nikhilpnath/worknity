    ...
    <div>
      <Menu as="div" className="inline-block text-left">
        <div className="flex">
          <Menu.Button className="inline-flex gap-2 w-full rouned-md bg-white px-4 py-2 text-sm font-medium text-slate-700 hover:bg-opacity-20">
            <div className="leading[80px] flex flex-col items-start">
              ...
              <span className="text-sm text-[#a52a2a]">{user?.email}</span>
            </div>
            ...
            <BiChevronDown className="h-10 w-9  " aria-hidden="true" />
          </Menu.Button>
        </div>
        ...
        >
          ...
          <Menu.Items
            className={`${position} z-50 right-2 mt-2 w-64 origin-top-right rounded-md bg-white shadow-lg focus:outline-none`}
          >
            <div className="p-1">
              <Menu.Item>
                {({ active }) => (
