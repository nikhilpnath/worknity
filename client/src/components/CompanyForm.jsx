...
const CompanyForm = ({ open, setOpen }) => {
  ...
  const { email, jobPosts, profileUrl, ...restCmpInfo } = companyInfo || {};
  ...
  const updateSchema = yup.object().shape({
    ...
    about: yup.string().min(80, "Tell us about your company").required(),
  });
  ...
  const {
    ...
    mode: "onChange",
    defaultValues: restCmpInfo ? { ...restCmpInfo } : {},
